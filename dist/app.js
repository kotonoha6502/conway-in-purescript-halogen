...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Conway.AppM"] = $PS["Conway.AppM"] || {};
  var exports = $PS["Conway.AppM"];
  var Control_Monad_Reader_Trans = $PS["Control.Monad.Reader.Trans"];
  var Effect_Aff = $PS["Effect.Aff"];
...
(function($PS) {
  ...
  var colMdOffset2 = "col-md-offset-2";
  var colMd8 = "col-md-8";
  var colMd6 = "col-md-6";
  var colMd5 = "col-md-5";
  var colMd4 = "col-md-4";
  ...
  exports["colMdOffset2"] = colMdOffset2;
...
(function($PS) {
  ...
  var component = function (dictMonadEffect) {
      var tdStyle = Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(18.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(18.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Color.rgb(192)(192)(192)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.px(11.0)))(function () {
      ...
      var render = function (v) {
          var rowLength = Data_Array.length(v.configuration);
          var makeRow = function (row) {
              var colLength = Data_Array.length(Data_Maybe.fromMaybe([  ])(Data_Function.flip(Data_Array.index)(row)(v.configuration)));
              return Halogen_HTML_Elements.tr_(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(colLength - 1 | 0))(function (col) {
                  var isAlive = Data_Maybe.fromMaybe(false)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(v.configuration)(row))(Data_Function.flip(Data_Array.index)(col)));
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Conway.Component.Board (line 56, column 20 - line 60, column 34): " + [ v.constructor.name ]);
      };
          ...
          var handleAction = function (v) {
              ...
              if (v instanceof HandleWidthInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (currentSt) {
                      ...
                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)($$new !== currentSt.width)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new WidthChanged($$new)))(function () {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              var $25 = {};
                              for (var $26 in currentSt) {
                                  if ({}.hasOwnProperty.call(currentSt, $26)) {
                                      $25[$26] = currentSt[$26];
                                  };
                              };
                              $25.width = $$new;
              ...
              if (v instanceof HandleWidthKeyDown) {
                  ...
                  if (v1 === "ArrowUp") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new WidthChanged(st.width + 1 | 0)))(function () {
                                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                      var $30 = {};
                                      for (var $31 in st) {
                  ...
                  if (v1 === "ArrowDown") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(st.width > 1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new WidthChanged(st.width - 1 | 0)))(function () {
                                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                      var $33 = {};
                                      for (var $34 in st) {
              ...
              if (v instanceof HandleHeightInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (currentSt) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)($$new !== currentSt.height)(Halogen_Query_HalogenM.raise(new HeightChanged($$new))))(function () {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              var $37 = {};
                              for (var $38 in currentSt) {
                                  if ({}.hasOwnProperty.call(currentSt, $38)) {
                                      $37[$38] = currentSt[$38];
                                  };
                              };
                              $37.height = $$new;
              ...
              if (v instanceof HandleHeightKeyDown) {
                  ...
                  if (v1 === "ArrowUp") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new HeightChanged(st.height + 1 | 0)))(function () {
                                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                      var $42 = {};
                                      for (var $43 in st) {
                  ...
                  if (v1 === "ArrowDown") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(st.height > 1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new HeightChanged(st.height - 1 | 0)))(function () {
                                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                      var $45 = {};
                                      for (var $46 in st) {
              ...
              if (v instanceof HandleStepInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (currentSt) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)($$new !== currentSt.step)(Halogen_Query_HalogenM.raise(new StepChanged($$new))))(function () {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              var $49 = {};
                              for (var $50 in currentSt) {
                                  if ({}.hasOwnProperty.call(currentSt, $50)) {
                                      $49[$50] = currentSt[$50];
                                  };
                              };
                              $49.step = $$new;
              ...
              if (v instanceof HandleStepKeyDown) {
                  ...
                  if (v1 === "ArrowUp") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new StepChanged(st.step + 100 | 0)))(function () {
                                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                      var $54 = {};
                                      for (var $55 in st) {
                  ...
                  if (v1 === "ArrowDown") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(st.step > 100)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new StepChanged(st.step - 1 | 0)))(function () {
                                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                      var $57 = {};
                                      for (var $58 in st) {
              ...
              if (v instanceof ForwardRunButtonClicked) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $61.isRunning = shouldAdvanceAuto;
                          return $61;
                      })()))(function () {
              ...
              throw new Error("Failed pattern match at Conway.Component.EditPanel (line 131, column 20 - line 227, column 25): " + [ v.constructor.name ]);
          };
          var btnStyle = Halogen_HTML_CSS.style(CSS_Geometry.marginRight(CSS_Size.px(16.0)));
          var render = function (v) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.containerFluid ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row, Halogen_Themes_Bootstrap3.formGroup ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd2 ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd4 ]) ])([ Halogen_HTML_Core.text("\u5e45") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd8 ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.formControl ]), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(v.width)), Halogen_HTML_Properties.disabled(v.isRunning), Halogen_HTML_Events.onValueInput(function ($75) {
                  return Data_Maybe.Just.create(HandleWidthInput.create($75));
              }), Halogen_HTML_Events.onKeyDown(function ($76) {
                  return Data_Maybe.Just.create(HandleWidthKeyDown.create($76));
              }) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd2 ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd4 ]) ])([ Halogen_HTML_Core.text("\u9ad8\u3055") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd8 ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.formControl ]), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(v.height)), Halogen_HTML_Properties.disabled(v.isRunning), Halogen_HTML_Events.onValueInput(function ($77) {
                  return Data_Maybe.Just.create(HandleHeightInput.create($77));
              }), Halogen_HTML_Events.onKeyDown(function ($78) {
                  return Data_Maybe.Just.create(HandleHeightKeyDown.create($78));
              }) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd2 ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd6 ]) ])([ Halogen_HTML_Core.text("\u30b9\u30c6\u30c3\u30d7") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd6 ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.formControl ]), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(v.step)), Halogen_HTML_Properties.disabled(v.isRunning), Halogen_HTML_Events.onValueInput(function ($79) {
                  return Data_Maybe.Just.create(HandleStepInput.create($79));
              }), Halogen_HTML_Events.onKeyDown(function ($80) {
                  return Data_Maybe.Just.create(HandleStepKeyDown.create($80));
              }) ]) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd5, Halogen_Themes_Bootstrap3.textLeft ]) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.btn, Halogen_Themes_Bootstrap3.btnPrimary ]), btnStyle, Halogen_HTML_Events.onClick(function (v1) {
                  ...
                  return "\u3059\u305f\u301c\u3068";
              })()) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.btn, Halogen_Themes_Bootstrap3.btnPrimary ]), btnStyle, Halogen_HTML_Events.onClick(function (v1) {
                  return new Data_Maybe.Just(ForwardResetButtonClicked.value);
              }) ])([ Halogen_HTML_Core.text("\u308a\u305b\u3063\u3068") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.btn, Halogen_Themes_Bootstrap3.btnPrimary ]), btnStyle, Halogen_HTML_Events.onClick(function (v1) {
...
(function($PS) {
  ...
  var toArray = function (n) {
      var $30 = Data_Array.fromFoldable(Data_List_Lazy_Types.foldableList);
      var $31 = Data_Stream.take(n);
      return function ($32) {
          return $30($31(right(Data_Zipper_Types.shiftl($32))));
      };
  };
  var modifyAt = function (v) {
      return function (f) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Data.Zipper (line 48, column 1 - line 48, column 62): " + [ v.constructor.name, f.constructor.name, v1.constructor.name ]);
          };
      };
  };
...
(function($PS) {
  ...
  var right = (function () {
      var $18 = Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Zipper_Types.shiftr);
      var $19 = Data_Newtype.unwrap(newtypeGrid);
      return function ($20) {
          return Grid($18($19($20)));
      };
  })();
  var up = (function () {
      var $21 = Data_Newtype.unwrap(newtypeGrid);
      return function ($22) {
          return Grid(Data_Zipper_Types.shiftl($21($22)));
      };
  })();
  ...
  var left = (function () {
      var $23 = Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Zipper_Types.shiftl);
      var $24 = Data_Newtype.unwrap(newtypeGrid);
      return function ($25) {
          return Grid($23($24($25)));
      };
  })();
  var functorGrid = new Data_Functor.Functor(function (f) {
      var $26 = Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Functor.map(Data_Zipper_Types.functorStream)(f));
      var $27 = Data_Newtype.unwrap(newtypeGrid);
      return function ($28) {
          return Grid($26($27($28)));
      };
  });
  var fromArray2 = function (a) {
      return function (xss) {
          var universe = Data_Stream.fromFoldable(Data_Foldable.foldableArray)(Data_Zipper.symmetric(a))(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $29 = Data_Zipper.fromStream(a);
              var $30 = Data_Stream.fromFoldable(Data_Foldable.foldableArray)(a);
              return function ($31) {
                  return $29($30($31));
              };
          })())(xss));
  ...
  var focus = (function () {
      var $32 = Control_Comonad.extract(Data_Zipper_Types.comonadZipper);
      var $33 = Control_Comonad.extract(Data_Zipper_Types.comonadZipper);
      var $34 = Data_Newtype.unwrap(newtypeGrid);
      return function ($35) {
          return $32($33($34($35)));
      };
  })();
  var extendGrid = new Control_Extend.Extend(function () {
      ...
      var $36 = Data_Functor.map(functorGrid)(f);
      return function ($37) {
          return $36(dupl($37));
      };
  });
  var down = (function () {
      ...
      return function ($39) {
          return Grid(Data_Zipper_Types.shiftr($38($39)));
      };
  })();
  exports["up"] = up;
  exports["down"] = down;
  ...
  var component = function (dictMonadEffect) {
      return function (dictMonadAff) {
          ...
          var handleEditPanelMessage = function (v) {
              ...
              throw new Error("Failed pattern match at Conway.Page.Conway (line 116, column 30 - line 122, column 58): " + [ v.constructor.name ]);
          };
          var handleAction = function (v) {
              ...
              throw new Error("Failed pattern match at Conway.Page.Conway (line 84, column 20 - line 113, column 42): " + [ v.constructor.name ]);
          };
          ...
          var render = function (v) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap3.containerFluid) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap3.row) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd10, Halogen_Themes_Bootstrap3.colMdOffset2, Halogen_Themes_Bootstrap3.textCenter ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-content") ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_("conway-title") ])([ Halogen_HTML_Core.text("\ud83c\udf35\u3089\u3044\u3075\u3052\u301c\u3080\ud83c\udf35") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-content-body") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-config-panel-area"), panelStyle ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  ...
                  configuration: Conway_Data_Grid.toArray2(v.width)(v.height)(v.configuration)
...
(function($PS) {
  ...
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Conway_AppM = $PS["Conway.AppM"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      ...
      var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(Conway_AppM.runAppM(env))(app(Conway_AppM.monadEffectAppM)(Conway_AppM.monadAffAppM));

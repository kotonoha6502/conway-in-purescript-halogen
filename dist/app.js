...
(function($PS) {
  ...
  exports["middleVerticalAlign"] = middleVerticalAlign;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Data.Stream.Types"] = $PS["Data.Stream.Types"] || {};
  var exports = $PS["Data.Stream.Types"];
  ...
  var newtypeStream = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Stream);
  var step = (function () {
      var $10 = Data_Newtype.unwrap(newtypeStream);
      return function ($11) {
          return Data_Lazy.force($10($11));
      };
  })();
  var lazyStream = new Control_Lazy.Lazy(function (f) {
      return Stream(Data_Lazy.defer(function ($12) {
          return step(f($12));
      }));
  });
  var functorStream = new Data_Functor.Functor(function (f) {
      return function (z) {
          var v = step(z);
          return Stream(Data_Lazy.defer(function (v1) {
              return Cons.create(f(v.value0))(Data_Functor.map(functorStream)(f)(v.value1));
          }));
      };
  });
  var cons = function (x) {
      return function (xs) {
          return Stream(Data_Lazy.defer(function (v) {
              return new Cons(x, xs);
          }));
      };
  };
  ...
  exports["step"] = step;
  exports["cons"] = cons;
  exports["newtypeStream"] = newtypeStream;
  exports["lazyStream"] = lazyStream;
  exports["functorStream"] = functorStream;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Data.Stream"] = $PS["Data.Stream"] || {};
  var exports = $PS["Data.Stream"];
  var Control_Lazy = $PS["Control.Lazy"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Lazy = $PS["Data.Lazy"];
  ...
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Newtype = $PS["Data.Newtype"];
  var Data_Stream_Types = $PS["Data.Stream.Types"];                
  var uncons = function (zs) {
      var v = Data_Stream_Types.step(zs);
      return {
          head: v.value0,
          tail: v.value1
      };
  ...
  var take = function (n) {
      var go = function (v) {
          return function (v1) {
              ...
              return Data_List_Lazy_Types.cons(v1.value0)(take(v - 1 | 0)(v1.value1));
          };
      };
      var $33 = go(n);
      return function ($34) {
          return $33(Data_Stream_Types.step($34));
      };
  };
  var tail = function ($35) {
      return (function (v) {
          return v.tail;
      })(uncons($35));
  };
  var repeat = function (x) {
      return Control_Lazy.fix(Data_Stream_Types.lazyStream)(function (xs) {
          return Data_Stream_Types.cons(x)(xs);
      });
  };
  var iterate = function (f) {
      return function (x) {
          return Data_Stream_Types.cons(x)(Control_Lazy.defer(Data_Stream_Types.lazyStream)(function (v) {
  ...
  var index = function (xs) {
      var go = function ($copy_v) {
          return function ($copy_v1) {
              ...
              function $tco_loop(v, v1) {
                  ...
                  $tco_var_v = Data_Stream_Types.step(v.value1);
                  $copy_v1 = v1 - 1 | 0;
                  return;
              };
              while (!$tco_done) {
      ...
      return go(Data_Stream_Types.step(xs));
  };
  var fromFoldable = function (dictFoldable) {
      return function (x) {
          return function (xs) {
              return Data_Foldable.foldr(dictFoldable)(Data_Stream_Types.cons)(repeat(x))(xs);
          };
      };
  };
              ...
              var go = function (v) {
                  return function (v1) {
                      if (v === 0) {
                          var v2 = f(v1.value0);
                          if (v2 instanceof Data_Maybe.Nothing) {
                              return Data_Stream_Types.step(v1.value1);
                          };
                          if (v2 instanceof Data_Maybe.Just) {
                              return new Data_Stream_Types.Cons(v2.value0, v1.value1);
                          };
                          throw new Error("Failed pattern match at Data.Stream (line 65, column 22 - line 67, column 26): " + [ v2.constructor.name ]);
                      };
                      return new Data_Stream_Types.Cons(v1.value0, alterAt(v - 1 | 0)(f)(v1.value1));
                  };
              };
              return Data_Functor.map(Data_Lazy.functorLazy)(go(n))(Data_Newtype.unwrap(Data_Stream_Types.newtypeStream)(xs));
          };
      };
  };
  var modifyAt = function (n) {
      return function (f) {
          return alterAt(n)(function ($37) {
              return Data_Maybe.Just.create(f($37));
          });
      };
  };
  exports["uncons"] = uncons;
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Data.Zipper.Types"] = $PS["Data.Zipper.Types"] || {};
  var exports = $PS["Data.Zipper.Types"];
  var Control_Comonad = $PS["Control.Comonad"];
  var Control_Extend = $PS["Control.Extend"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Stream = $PS["Data.Stream"];
  var Data_Stream_Types = $PS["Data.Stream.Types"];                
  var Zipper = (function () {
  ...
  var shiftr = function (v) {
      var v1 = Data_Stream_Types.step(v.value2);
      return new Zipper(Data_Stream_Types.cons(v.value1)(v.value0), v1.value0, v1.value1);
  };
  var shiftl = function (v) {
      var v1 = Data_Stream_Types.step(v.value0);
      return new Zipper(v1.value1, v1.value0, Data_Stream_Types.cons(v.value1)(v.value2));
  };
  var functorStream = new Data_Functor.Functor(function (f) {
      return function (v) {
          return new Zipper(Data_Functor.map(Data_Stream_Types.functorStream)(f)(v.value0), f(v.value1), Data_Functor.map(Data_Stream_Types.functorStream)(f)(v.value2));
      };
  });
  var extendZipper = new Control_Extend.Extend(function () {
      ...
      var dupl = function (z) {
          return new Zipper(Data_Stream.tail(Data_Stream.iterate(shiftl)(z)), z, Data_Stream.tail(Data_Stream.iterate(shiftr)(z)));
      };
      var $29 = Data_Functor.map(functorStream)(f);
      return function ($30) {
          return $29(dupl($30));
      };
  });
  ...
  exports["functorStream"] = functorStream;
  exports["comonadZipper"] = comonadZipper;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Data.Zipper"] = $PS["Data.Zipper"] || {};
  var exports = $PS["Data.Zipper"];
  var Data_Array = $PS["Data.Array"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_List_Lazy_Types = $PS["Data.List.Lazy.Types"];
  var Data_Stream = $PS["Data.Stream"];
  var Data_Stream_Types = $PS["Data.Stream.Types"];
  var Data_Zipper_Types = $PS["Data.Zipper.Types"];                
  var symmetric = function (a) {
      return new Data_Zipper_Types.Zipper(Data_Stream.repeat(a), a, Data_Stream.repeat(a));
  };
  var right = function (v) {
      return v.value2;
  };
  var toArray = function (n) {
      var $40 = Data_Array.fromFoldable(Data_List_Lazy_Types.foldableList);
      var $41 = Data_Stream.take(n);
      return function ($42) {
          return $40($41(right(Data_Zipper_Types.shiftl($42))));
      };
  };
  var modifyAt = function (v) {
      return function (f) {
          return function (v1) {
              if (v === 0) {
                  return new Data_Zipper_Types.Zipper(v1.value0, f(v1.value1), v1.value2);
              };
              if (v < 0) {
                  return new Data_Zipper_Types.Zipper(Data_Stream.modifyAt(((-1 | 0) * v | 0) - 1 | 0)(f)(v1.value0), v1.value1, v1.value2);
              };
              if (Data_Boolean.otherwise) {
                  return new Data_Zipper_Types.Zipper(v1.value0, v1.value1, Data_Stream.modifyAt(v - 1 | 0)(f)(v1.value2));
              };
              throw new Error("Failed pattern match at Data.Zipper (line 49, column 1 - line 49, column 62): " + [ v.constructor.name, f.constructor.name, v1.constructor.name ]);
          };
      };
  };
  var index = function (v) {
      return function (v1) {
          ...
          if (v1 < 0) {
              return Data_Stream.index(v.value0)(((-1 | 0) * v1 | 0) - 1 | 0);
          };
          if (Data_Boolean.otherwise) {
              return Data_Stream.index(v.value2)(v1 - 1 | 0);
          };
          throw new Error("Failed pattern match at Data.Zipper (line 55, column 1 - line 55, column 40): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var fromStream = function (x) {
      return function (xs) {
          var v = Data_Stream_Types.step(xs);
          return new Data_Zipper_Types.Zipper(Data_Stream.repeat(x), v.value0, v.value1);
      };
  };
  var fromFoldable = function (dictFoldable) {
      return function (x) {
          return function (xs) {
              var ys = Data_Stream.fromFoldable(dictFoldable)(x)(xs);
              var v = Data_Stream.uncons(ys);
              return new Data_Zipper_Types.Zipper(Data_Stream.repeat(x), v.head, v.tail);
          };
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Conway.Data.Grid"] = $PS["Conway.Data.Grid"] || {};
  var exports = $PS["Conway.Data.Grid"];
  var Control_Comonad = $PS["Control.Comonad"];
  var Control_Extend = $PS["Control.Extend"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Newtype = $PS["Data.Newtype"];
  var Data_Stream = $PS["Data.Stream"];
  var Data_Zipper = $PS["Data.Zipper"];
  var Data_Zipper_Types = $PS["Data.Zipper.Types"];                
  var Grid = function (x) {
      return x;
  };
  var toArray2 = function (i) {
      return function (j) {
          return function (v) {
              return Data_Zipper.toArray(j)(Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Zipper.toArray(i))(v));
          };
      };
  };
  var newtypeGrid = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Grid);
  var right = (function () {
      var $22 = Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Zipper_Types.shiftr);
      var $23 = Data_Newtype.unwrap(newtypeGrid);
      return function ($24) {
          return Grid($22($23($24)));
      };
  })();
  var up = (function () {
      var $25 = Data_Newtype.unwrap(newtypeGrid);
      return function ($26) {
          return Grid(Data_Zipper_Types.shiftl($25($26)));
      };
  })();
  var modifyAt = function (i) {
      return function (j) {
          return function (f) {
              return function (v) {
                  return Grid(Data_Zipper.modifyAt(i)(Data_Zipper.modifyAt(j)(f))(v));
              };
          };
      };
  };
  var left = (function () {
      var $27 = Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Zipper_Types.shiftl);
      var $28 = Data_Newtype.unwrap(newtypeGrid);
      return function ($29) {
          return Grid($27($28($29)));
      };
  })();
  var index = function (v) {
      return function (i) {
          return function (j) {
              return Data_Zipper.index(Data_Zipper.index(v)(i))(j);
          };
      };
  };
  var functorGrid = new Data_Functor.Functor(function (f) {
      var $30 = Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Functor.map(Data_Zipper_Types.functorStream)(f));
      var $31 = Data_Newtype.unwrap(newtypeGrid);
      return function ($32) {
          return Grid($30($31($32)));
      };
  });
  var fromArray2 = function (a) {
      return function (xss) {
          var universe = Data_Stream.fromFoldable(Data_Foldable.foldableArray)(Data_Zipper.symmetric(a))(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $33 = Data_Zipper.fromStream(a);
              var $34 = Data_Stream.fromFoldable(Data_Foldable.foldableArray)(a);
              return function ($35) {
                  return $33($34($35));
              };
          })())(xss));
          var v = Data_Stream.uncons(universe);
          return Grid(new Data_Zipper_Types.Zipper(Data_Stream.repeat(Data_Zipper.symmetric(a)), v.head, v.tail));
      };
  };
  var focus = (function () {
      var $36 = Control_Comonad.extract(Data_Zipper_Types.comonadZipper);
      var $37 = Control_Comonad.extract(Data_Zipper_Types.comonadZipper);
      var $38 = Data_Newtype.unwrap(newtypeGrid);
      return function ($39) {
          return $36($37($38($39)));
      };
  })();
  var extendGrid = new Control_Extend.Extend(function () {
      return functorGrid;
  }, function (f) {
      var layer = function (zzs) {
          var rights = Data_Stream.tail(Data_Stream.iterate(Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Zipper_Types.shiftr))(zzs));
          var lefts = Data_Stream.tail(Data_Stream.iterate(Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Zipper_Types.shiftl))(zzs));
          return new Data_Zipper_Types.Zipper(lefts, zzs, rights);
      };
      var dupl = function (v) {
          return Data_Functor.map(functorGrid)(Grid)(Grid(layer(layer(v))));
      };
      var $40 = Data_Functor.map(functorGrid)(f);
      return function ($41) {
          return $40(dupl($41));
      };
  });
  var down = (function () {
      var $42 = Data_Newtype.unwrap(newtypeGrid);
      return function ($43) {
          return Grid(Data_Zipper_Types.shiftr($42($43)));
      };
  })();
  exports["up"] = up;
  exports["down"] = down;
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Conway.Data.Game"] = $PS["Conway.Data.Game"] || {};
  var exports = $PS["Conway.Data.Game"];
  var Control_Extend = $PS["Control.Extend"];
  var Conway_Data_Grid = $PS["Conway.Data.Grid"];
  var Data_Array = $PS["Data.Array"];
  var Data_Tuple = $PS["Data.Tuple"];                
  var rule = function (b) {
      var ur = Conway_Data_Grid.focus(Conway_Data_Grid.right(Conway_Data_Grid.up(b)));
      var ul = Conway_Data_Grid.focus(Conway_Data_Grid.left(Conway_Data_Grid.up(b)));
      var u = Conway_Data_Grid.focus(Conway_Data_Grid.up(b));
      var r = Conway_Data_Grid.focus(Conway_Data_Grid.right(b));
      var l = Conway_Data_Grid.focus(Conway_Data_Grid.left(b));
      var dr = Conway_Data_Grid.focus(Conway_Data_Grid.right(Conway_Data_Grid.down(b)));
      var dl = Conway_Data_Grid.focus(Conway_Data_Grid.left(Conway_Data_Grid.down(b)));
      var d = Conway_Data_Grid.focus(Conway_Data_Grid.down(b));
      var n = Data_Array.length(Data_Array.filter(function (v) {
          return v === true;
      })([ u, r, d, l, ur, ul, dr, dl ]));
      var c = Conway_Data_Grid.focus(b);
      return c && (n === 2 || n === 3) || !c && n === 3;
  };
  var next = function (i) {
      return function (j) {
          var $1 = Conway_Data_Grid.fromArray2(false);
          var $2 = Conway_Data_Grid.toArray2(i)(j);
          var $3 = Control_Extend.extend(Conway_Data_Grid.extendGrid)(rule);
          return function ($4) {
              return $1($2($3($4)));
          };
      };
  };
  var initialState = Conway_Data_Grid.fromArray2(false)([ [ false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false ], [ true, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false ], [ false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false ], [ false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false ], [ false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false ], [ false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false ], [ false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false ], [ false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false ], [ false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false ], [ false, false, false, false, false, false, true, true, true, false, false, false, false, false, false, false ], [ false, false, false, false, false, false, true, false, true, false, false, false, false, false, false, false ], [ false, false, false, false, false, true, true, false, false, false, true, false, false, false, false, false ], [ false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false ], [ false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false ] ]);
  var defaultLegendId = "lambda";
  var defaultLegend = "\u03bb";
  var aliveLegend = [ new Data_Tuple.Tuple(defaultLegendId, defaultLegend), new Data_Tuple.Tuple("spago", "\ud83c\udf5d"), new Data_Tuple.Tuple("ramen", "\ud83c\udf5c"), new Data_Tuple.Tuple("sushi", "\ud83c\udf63"), new Data_Tuple.Tuple("beer", "\ud83c\udf7a"), new Data_Tuple.Tuple("kani", "\ud83e\udd80"), new Data_Tuple.Tuple("saboten", "\ud83c\udf35"), new Data_Tuple.Tuple("frame", "\ud83d\udd25"), new Data_Tuple.Tuple("smile", "\ud83d\ude03"), new Data_Tuple.Tuple("pien", "\ud83e\udd7a"), new Data_Tuple.Tuple("minesweeper", "\ud83d\ude0e"), new Data_Tuple.Tuple("hustle", "\ud83d\ude24"), new Data_Tuple.Tuple("yoshiko", "\ud83d\udc7f"), new Data_Tuple.Tuple("ghost", "\ud83d\udc7b"), new Data_Tuple.Tuple("alien", "\ud83d\udc7e") ];
  exports["initialState"] = initialState;
  exports["aliveLegend"] = aliveLegend;
  exports["defaultLegend"] = defaultLegend;
  exports["defaultLegendId"] = defaultLegendId;
  exports["next"] = next;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Halogen.Themes.Bootstrap3"] = $PS["Halogen.Themes.Bootstrap3"] || {};
  var exports = $PS["Halogen.Themes.Bootstrap3"];
  ...
  exports["colMd12"] = colMd12;
  exports["colMd3"] = colMd3;
  exports["colMd4"] = colMd4;
  exports["colMd5"] = colMd5;
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Conway.Component.Board"] = $PS["Conway.Component.Board"] || {};
  var exports = $PS["Conway.Component.Board"];
  ...
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Conway_Data_Game = $PS["Conway.Data.Game"];
  var Conway_Data_Grid = $PS["Conway.Data.Grid"];
  var Data_Array = $PS["Data.Array"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Halogen_Themes_Bootstrap3 = $PS["Halogen.Themes.Bootstrap3"];                
  var ToggleAlive = (function () {
      function ToggleAlive(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ToggleAlive.create = function (value0) {
          return function (value1) {
              return new ToggleAlive(value0, value1);
          };
      };
      return ToggleAlive;
  })();
  var ReceiveNextInput = (function () {
      function ReceiveNextInput(value0) {
          this.value0 = value0;
      };
      ReceiveNextInput.create = function (value0) {
          return new ReceiveNextInput(value0);
      };
      return ReceiveNextInput;
  })();
  ...
  var component = function (dictMonadEffect) {
      var tdStyle = Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(18.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(18.0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Color.rgb(192)(192)(192)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.px(12.0)))(function () {
                      return CSS_VerticalAlign.verticalAlign(CSS_Common.middle(CSS_VerticalAlign.middleVerticalAlign));
                  });
              });
          });
      }));
      var tableStyle = Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.fontSize(CSS_Size.px(20.0)))(function () {
          return CSS_Background.backgroundColor(Color.rgb(27)(82)(121));
      }));
      var receive = function (input) {
          return Data_Maybe.Just.create(new ReceiveNextInput(input));
      };
      ...
      var handleAction = function (v) {
          if (v instanceof ReceiveNextInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      $15.configuration = v.value0.configuration;
                      $15.height = v.value0.height;
                      $15.width = v.value0.width;
                      $15.genCount = v.value0.genCount;
                      $15.legend = v.value0.legend;
                      return $15;
                  })());
              });
          };
          if (v instanceof CellClicked) {
              return Halogen_Query_HalogenM.raise(new ToggleAlive(v.value0, v.value1));
          };
          throw new Error("Failed pattern match at Conway.Component.Board (line 72, column 20 - line 83, column 34): " + [ v.constructor.name ]);
      };
      var boardStyle = Halogen_HTML_CSS.style(CSS_Display.display(CSS_Display.inlineBlock));
      var render = function (v) {
          var character = Data_Maybe.fromMaybe(Conway_Data_Game.defaultLegend)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Tuple.snd)(Data_Foldable.find(Data_Foldable.foldableArray)(function (v1) {
              return v1.value0 === v.legend;
          })(Conway_Data_Game.aliveLegend)));
          var makeRow = function (row) {
              return Halogen_HTML_Elements.tr_(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(v.width - 1 | 0))(function (col) {
                  var isAlive = Conway_Data_Grid.index(v.configuration)(row)(col);
                  return Halogen_HTML_Elements.td([ tdStyle, Halogen_HTML_Events.onClick(function (v1) {
                      return Data_Maybe.Just.create(new CellClicked(row, col));
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "conway-game-board", Halogen_Themes_Bootstrap3.containerFluid ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd12 ]) ])([ Halogen_HTML_Elements.div([ boardStyle ])([ Halogen_HTML_Elements.table([ tableStyle, Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.centerBlock ]) ])([ Halogen_HTML_Elements.tbody([  ])(Data_Functor.map(Data_Functor.functorArray)(makeRow)(Data_Array.range(0)(v.height - 1 | 0))) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd12 ]) ])([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("\u73fe\u5728\uff1a") ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("\u7b2c " + (Data_Show.show(Data_Show.showInt)(v.genCount) + " \u4e16\u4ee3")) ]) ]) ]) ]);
      };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Conway.Component.EditPanel"] = $PS["Conway.Component.EditPanel"] || {};
  var exports = $PS["Conway.Component.EditPanel"];
  var CSS_Display = $PS["CSS.Display"];
  var CSS_Geometry = $PS["CSS.Geometry"];
  var CSS_Size = $PS["CSS.Size"];
  var Control_Applicative = $PS["Control.Applicative"];
  ...
  var WidthChanged = (function () {
      function WidthChanged(value0) {
          this.value0 = value0;
      };
      WidthChanged.create = function (value0) {
          return new WidthChanged(value0);
      };
      return WidthChanged;
  })();
  var HeightChanged = (function () {
      function HeightChanged(value0) {
          this.value0 = value0;
      };
      HeightChanged.create = function (value0) {
          return new HeightChanged(value0);
      };
      return HeightChanged;
  })();
  var StepChanged = (function () {
      function StepChanged(value0) {
          this.value0 = value0;
      };
      StepChanged.create = function (value0) {
          return new StepChanged(value0);
      };
      return StepChanged;
  })();
  var LegendChanged = (function () {
      function LegendChanged(value0) {
          this.value0 = value0;
      };
      LegendChanged.create = function (value0) {
          return new LegendChanged(value0);
      };
      return LegendChanged;
  })();
  var RunButtonClicked = (function () {
      function RunButtonClicked() {

      };
      RunButtonClicked.value = new RunButtonClicked();
  ...
  var ResetButtonClicked = (function () {
      ...
      ResetButtonClicked.value = new ResetButtonClicked();
  ...
  var HandleWidthInput = (function () {
      function HandleWidthInput(value0) {
          this.value0 = value0;
      };
      HandleWidthInput.create = function (value0) {
          return new HandleWidthInput(value0);
      };
      return HandleWidthInput;
  })();
  var HandleWidthKeyDown = (function () {
      function HandleWidthKeyDown(value0) {
          this.value0 = value0;
      };
      HandleWidthKeyDown.create = function (value0) {
          return new HandleWidthKeyDown(value0);
      };
      return HandleWidthKeyDown;
  })();
  var HandleHeightInput = (function () {
      function HandleHeightInput(value0) {
          this.value0 = value0;
      };
      HandleHeightInput.create = function (value0) {
          return new HandleHeightInput(value0);
      };
      return HandleHeightInput;
  })();
  var HandleHeightKeyDown = (function () {
      function HandleHeightKeyDown(value0) {
          this.value0 = value0;
      };
      HandleHeightKeyDown.create = function (value0) {
          return new HandleHeightKeyDown(value0);
      };
      return HandleHeightKeyDown;
  })();
  var HandleStepInput = (function () {
      function HandleStepInput(value0) {
          this.value0 = value0;
      };
      HandleStepInput.create = function (value0) {
          return new HandleStepInput(value0);
      };
      return HandleStepInput;
  })();
  var HandleStepKeyDown = (function () {
      function HandleStepKeyDown(value0) {
          this.value0 = value0;
      };
      HandleStepKeyDown.create = function (value0) {
          return new HandleStepKeyDown(value0);
      };
      return HandleStepKeyDown;
  })();
  var HandleLegendSelect = (function () {
      function HandleLegendSelect(value0) {
          this.value0 = value0;
      };
      HandleLegendSelect.create = function (value0) {
          return new HandleLegendSelect(value0);
      };
      return HandleLegendSelect;
  })();
  var ForwardRunButtonClicked = (function () {
      function ForwardRunButtonClicked() {

      };
      ForwardRunButtonClicked.value = new ForwardRunButtonClicked();
      return ForwardRunButtonClicked;
  })();
  var ForwardResetButtonClicked = (function () {
      function ForwardResetButtonClicked() {

      };
      ForwardResetButtonClicked.value = new ForwardResetButtonClicked();
      return ForwardResetButtonClicked;
  })();
  var NextInputReceived = (function () {
      function NextInputReceived(value0) {
          this.value0 = value0;
      };
      NextInputReceived.create = function (value0) {
          return new NextInputReceived(value0);
      };
      return NextInputReceived;
  })();
  var AdvanceBtnClicked = (function () {
      function AdvanceBtnClicked() {

      };
      AdvanceBtnClicked.value = new AdvanceBtnClicked();
      return AdvanceBtnClicked;
  })();
  var component = function (dictMonadEffect) {
      return function (dictMonadAff) {
          var receive = function (input) {
              return Data_Maybe.Just.create(new NextInputReceived(input));
          };
          var initialState = Control_Category.identity(Control_Category.categoryFn);
          var handleAction = function (v) {
              if (v instanceof NextInputReceived) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0);
              };
              if (v instanceof ForwardResetButtonClicked) {
                  return Halogen_Query_HalogenM.raise(ResetButtonClicked.value);
              };
              if (v instanceof HandleWidthInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (currentSt) {
                      var $$new = Data_Maybe.fromMaybe(currentSt.width)(Data_Int.fromString(v.value0));
                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)($$new !== currentSt.width)(Halogen_Query_HalogenM.raise(new WidthChanged($$new)));
                  });
              };
              if (v instanceof HandleWidthKeyDown) {
                  ...
                  if (v1 === "ArrowUp") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Halogen_Query_HalogenM.raise(new WidthChanged(st.width + 1 | 0));
                          });
                      });
                  };
                  if (v1 === "ArrowDown") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(st.width > 1)(Halogen_Query_HalogenM.raise(new WidthChanged(st.width - 1 | 0)));
                          });
                      });
                  };
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              if (v instanceof HandleHeightInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (currentSt) {
                      var $$new = Data_Maybe.fromMaybe(currentSt.height)(Data_Int.fromString(v.value0));
                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)($$new !== currentSt.height)(Halogen_Query_HalogenM.raise(new HeightChanged($$new)));
                  });
              };
              if (v instanceof HandleHeightKeyDown) {
                  var v1 = Web_UIEvent_KeyboardEvent.code(v.value0);
                  if (v1 === "ArrowUp") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Halogen_Query_HalogenM.raise(new HeightChanged(st.height + 1 | 0));
                          });
                      });
                  };
                  if (v1 === "ArrowDown") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(st.height > 1)(Halogen_Query_HalogenM.raise(new HeightChanged(st.height - 1 | 0)));
                          });
                      });
                  };
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              if (v instanceof HandleStepInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (currentSt) {
                      var $$new = Data_Maybe.fromMaybe(currentSt.step)(Data_Int.fromString(v.value0));
                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)($$new !== currentSt.step)(Halogen_Query_HalogenM.raise(new StepChanged($$new)));
                  });
              };
              if (v instanceof HandleStepKeyDown) {
                  var v1 = Web_UIEvent_KeyboardEvent.code(v.value0);
                  if (v1 === "ArrowUp") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Halogen_Query_HalogenM.raise(new StepChanged(st.step + 100 | 0));
                          });
                      });
                  };
                  if (v1 === "ArrowDown") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(st.step > 100)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new StepChanged(st.step - 100 | 0)))(function () {
                                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                      var $26 = {};
                                      for (var $27 in st) {
              ...
              if (v instanceof ForwardRunButtonClicked) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      var shouldAdvanceAuto = !st.isRunning;
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $30.isRunning = shouldAdvanceAuto;
                          return $30;
                      })()))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(RunButtonClicked.value))(function () {
                              var autoAdvance = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Int.toNumber(v1.step))))(function () {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                                          if (v2.isRunning) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(Advanced.value))(function () {
                                                  return autoAdvance;
                                              });
                                          };
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              ...
                              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(shouldAdvanceAuto)(autoAdvance);
                          });
                      });
                  });
              };
              if (v instanceof HandleLegendSelect) {
                  return Halogen_Query_HalogenM.raise(new LegendChanged(v.value0));
              };
              if (v instanceof AdvanceBtnClicked) {
                  return Halogen_Query_HalogenM.raise(Advanced.value);
              };
              throw new Error("Failed pattern match at Conway.Component.EditPanel (line 146, column 20 - line 236, column 25): " + [ v.constructor.name ]);
          };
          var editPanelStyle = Halogen_HTML_CSS.style(CSS_Display.display(CSS_Display.inlineBlock));
          var btnStyle = Halogen_HTML_CSS.style(CSS_Geometry.marginRight(CSS_Size.px(32.0)));
          var render = function (v) {
              return Halogen_HTML_Elements.div([ editPanelStyle ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row, Halogen_Themes_Bootstrap3.formGroup ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd5 ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd4 ]) ])([ Halogen_HTML_Core.text("\u30b5\u30a4\u30ba") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd3 ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.formControl ]), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(v.width)), Halogen_HTML_Properties.disabled(v.isRunning), Halogen_HTML_Events.onValueInput(function ($49) {
                  return Data_Maybe.Just.create(HandleWidthInput.create($49));
              }), Halogen_HTML_Events.onKeyDown(function ($50) {
                  return Data_Maybe.Just.create(HandleWidthKeyDown.create($50));
              }) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd1 ]) ])([ Halogen_HTML_Core.text("\u2715") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd3 ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.formControl ]), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(v.height)), Halogen_HTML_Properties.disabled(v.isRunning), Halogen_HTML_Events.onValueInput(function ($51) {
                  return Data_Maybe.Just.create(HandleHeightInput.create($51));
              }), Halogen_HTML_Events.onKeyDown(function ($52) {
                  return Data_Maybe.Just.create(HandleHeightKeyDown.create($52));
              }) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd3 ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd6 ]) ])([ Halogen_HTML_Core.text("\u30b9\u30c6\u30c3\u30d7\x0a/ms") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd6 ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.formControl ]), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(v.step)), Halogen_HTML_Properties.disabled(v.isRunning), Halogen_HTML_Events.onValueInput(function ($53) {
                  return Data_Maybe.Just.create(HandleStepInput.create($53));
              }), Halogen_HTML_Events.onKeyDown(function ($54) {
                  return Data_Maybe.Just.create(HandleStepKeyDown.create($54));
              }) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd3 ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd6 ]) ])([ Halogen_HTML_Core.text("\u51e1\u4f8b") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd6 ]) ])([ Halogen_HTML_Elements.select([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.formControl ]), Halogen_HTML_Events.onValueChange(function ($55) {
                  return Data_Maybe.Just.create(HandleLegendSelect.create($55));
              }) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Conway_Data_Game.aliveLegend)(function (v1) {
                  return Halogen_HTML_Elements.option([ Halogen_HTML_Properties.value(v1.value0), Halogen_HTML_Properties.selected(v1.value0 === v.legend) ])([ Halogen_HTML_Core.text(v1.value1) ]);
              })) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.row ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd12, Halogen_Themes_Bootstrap3.textLeft ]) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.btn, Halogen_Themes_Bootstrap3.btnPrimary ]), btnStyle, Halogen_HTML_Events.onClick(function (v1) {
                  return new Data_Maybe.Just(ForwardRunButtonClicked.value);
              }) ])([ Halogen_HTML_Core.text((function () {
                  if (v.isRunning) {
                      return "\u3059\u3068\u3063\u3077";
                  };
                  return "\u3059\u305f\u301c\u3068";
              })()) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.btn, "btn-outline-primary" ]), btnStyle, Halogen_HTML_Events.onClick(function (v1) {
                  return new Data_Maybe.Just(ForwardResetButtonClicked.value);
              }) ])([ Halogen_HTML_Core.text("\u308a\u305b\u3063\u3068") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.btn, "btn-outline-primary" ]), btnStyle, Halogen_HTML_Events.onClick(function (v1) {
                  return new Data_Maybe.Just(AdvanceBtnClicked.value);
              }) ])([ Halogen_HTML_Core.text("+1\u4e16\u4ee3") ]) ]) ]) ]);
          };
          return Halogen_Component.mkComponent({
              initialState: initialState,
              render: render,
  ...
  exports["WidthChanged"] = WidthChanged;
  exports["HeightChanged"] = HeightChanged;
  exports["StepChanged"] = StepChanged;
  exports["LegendChanged"] = LegendChanged;
  exports["RunButtonClicked"] = RunButtonClicked;
  exports["ResetButtonClicked"] = ResetButtonClicked;
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Conway.Page.Conway"] = $PS["Conway.Page.Conway"] || {};
  var exports = $PS["Conway.Page.Conway"];
  var CSS_Geometry = $PS["CSS.Geometry"];
  var CSS_Size = $PS["CSS.Size"];
  var CSS_Stylesheet = $PS["CSS.Stylesheet"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Conway_Component_Board = $PS["Conway.Component.Board"];
  var Conway_Component_EditPanel = $PS["Conway.Component.EditPanel"];
  var Conway_Data_Game = $PS["Conway.Data.Game"];
  var Conway_Data_Grid = $PS["Conway.Data.Grid"];
  ...
  var RunStatusChanged = (function () {
      function RunStatusChanged() {

      };
      RunStatusChanged.value = new RunStatusChanged();
  ...
  var ResetFired = (function () {
      ...
      ResetFired.value = new ResetFired();
      return ResetFired;
  })();
  var NextGeneration = (function () {
      ...
      NextGeneration.value = new NextGeneration();
      return NextGeneration;
  })();
  var AliveToggled = (function () {
      function AliveToggled(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      AliveToggled.create = function (value0) {
          return function (value1) {
              return new AliveToggled(value0, value1);
          };
      };
      return AliveToggled;
  })();
  var component = function (dictMonadEffect) {
      return function (dictMonadAff) {
          var panelStyle = Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Size.px(8.0)))(function () {
              return CSS_Geometry.marginBottom(CSS_Size.px(8.0));
          }));
          var initialState = function (v) {
              return {
                  width: 16,
                  ...
                  isRunning: false,
                  step: 500,
                  configuration: Conway_Data_Game.initialState,
                  genCount: 0,
                  legend: Conway_Data_Game.defaultLegendId
              };
          };
          var handleGameBoardMessage = function (v) {
              return Data_Maybe.Just.create(new AliveToggled(v.value0, v.value1));
          };
          var handleEditPanelMessage = function (v) {
              if (v instanceof Conway_Component_EditPanel.WidthChanged) {
                  return Data_Maybe.Just.create(WidthChanged.create(v.value0));
              };
              if (v instanceof Conway_Component_EditPanel.HeightChanged) {
                  return Data_Maybe.Just.create(HeightChanged.create(v.value0));
              };
              if (v instanceof Conway_Component_EditPanel.RunButtonClicked) {
                  return new Data_Maybe.Just(RunStatusChanged.value);
              };
              if (v instanceof Conway_Component_EditPanel.ResetButtonClicked) {
                  return new Data_Maybe.Just(ResetFired.value);
              };
              if (v instanceof Conway_Component_EditPanel.Advanced) {
                  return new Data_Maybe.Just(NextGeneration.value);
              };
              if (v instanceof Conway_Component_EditPanel.StepChanged) {
                  return Data_Maybe.Just.create(StepChanged.create(v.value0));
              };
              if (v instanceof Conway_Component_EditPanel.LegendChanged) {
                  return Data_Maybe.Just.create(LegendChanged.create(v.value0));
              };
              throw new Error("Failed pattern match at Conway.Page.Conway (line 128, column 30 - line 135, column 64): " + [ v.constructor.name ]);
          };
          var handleAction = function (v) {
              if (v instanceof WidthChanged) {
                  var w = Data_Ord.min(Data_Ord.ordInt)(50)(Data_Ord.max(Data_Ord.ordInt)(5)(v.value0));
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $24 = {};
                          for (var $25 in st) {
              ...
              if (v instanceof HeightChanged) {
                  var h = Data_Ord.min(Data_Ord.ordInt)(35)(Data_Ord.max(Data_Ord.ordInt)(5)(v.value0));
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $28 = {};
                          for (var $29 in st) {
              ...
              if (v instanceof RunStatusChanged) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $40 = {};
                          for (var $41 in st) {
                          ...
                          $40.isRunning = !st.isRunning;
                          return $40;
                      })());
                  });
              };
              if (v instanceof ResetFired) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(initialState(Data_Unit.unit));
              };
              if (v instanceof NextGeneration) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      var nx = Conway_Data_Game.next(st.width)(st.height)(st.configuration);
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $43 = {};
                          for (var $44 in st) {
                          ...
                          $43.configuration = nx;
                          $43.genCount = st.genCount + 1 | 0;
                          return $43;
                      })());
                  });
              };
              if (v instanceof AliveToggled) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      var nx = Conway_Data_Grid.modifyAt(v.value0)(v.value1)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(st.configuration);
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $46 = {};
                          for (var $47 in st) {
              ...
              throw new Error("Failed pattern match at Conway.Page.Conway (line 90, column 20 - line 125, column 42): " + [ v.constructor.name ]);
          };
          var boardStyle = Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Size.px(16.0)))(function () {
              return CSS_Geometry.marginBottom(CSS_Size.px(8.0));
          }));
          var render = function (v) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap3.containerFluid) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap3.row) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd10, "offset-md-1", Halogen_Themes_Bootstrap3.textCenter ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-content") ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_("conway-title") ])([ Halogen_HTML_Core.text("\ud83c\udf35\u3089\u3044\u3075\u3052\u301c\u3080\ud83c\udf35") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-content-body") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-config-panel-area"), panelStyle ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "editPanel";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Conway_Component_EditPanel.component(dictMonadAff.MonadEffect0())(dictMonadAff))({
                  width: v.width,
                  height: v.height,
                  step: v.step,
                  isRunning: v.isRunning,
                  legend: v.legend
              })(handleEditPanelMessage) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-game-board-area"), boardStyle ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "board";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Conway_Component_Board.component(dictMonadAff.MonadEffect0()))({
                  width: v.width,
                  height: v.height,
                  configuration: v.configuration,
                  genCount: v.genCount,
                  legend: v.legend
              })(handleGameBoardMessage) ]) ]) ]) ]) ]) ]);
          };
          return Halogen_Component.mkComponent({
              initialState: initialState,
              render: render,
...
(function($PS) {
  ...
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Conway_Page_Conway = $PS["Conway.Page.Conway"];
  var Data_Function = $PS["Data.Function"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Data_Unit = $PS["Data.Unit"];
  ...
  var app = function (dictMonadEffect) {
      return function (dictMonadAff) {
          var render = function (v) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("app") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "view";
              }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Conway_Page_Conway.component(dictMonadAff.MonadEffect0())(dictMonadAff))(Data_Unit.unit)(Data_Void.absurd) ]);
          };
          return Halogen_Component.mkComponent({
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(app(Effect_Aff.monadEffectAff)(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body))(function (halogenIO) {

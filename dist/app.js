...
(function($PS) {
  ...
  var colMdOffset4 = "col-md-offset-4";
  var colMd8 = "col-md-8";
  var colMd6 = "col-md-6";
  var colMd5 = "col-md-5";
  var colMd4 = "col-md-4";
  ...
  exports["colMdOffset4"] = colMdOffset4;
...
(function($PS) {
  ...
  var component = function (dictMonadEffect) {
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Conway.Component.Board (line 62, column 20 - line 67, column 34): " + [ v.constructor.name ]);
      };
              ...
              if (v instanceof ForwardRunButtonClicked) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $29.isRunning = shouldAdvanceAuto;
                          return $29;
                      })()))(function () {
  ...
  var component = function (dictMonadEffect) {
      return function (dictMonadAff) {
          ...
          var handleEditPanelMessage = function (v) {
              ...
              throw new Error("Failed pattern match at Conway.Page.Conway (line 120, column 30 - line 126, column 58): " + [ v.constructor.name ]);
          };
          var handleAction = function (v) {
              ...
              throw new Error("Failed pattern match at Conway.Page.Conway (line 86, column 20 - line 117, column 42): " + [ v.constructor.name ]);
          };

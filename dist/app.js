      ...
      var render = function (v) {
          ...
          var makeRow = function (row) {
              ...
              return Halogen_HTML_Elements.tr_(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.range(0)(colLength - 1 | 0))(function (col) {
                  ...
                  return Halogen_HTML_Elements.td([ tdStyle ])([ Halogen_HTML_Core.text((function () {
                      if (isAlive) {
                          return "X";
                      };
                      return ".";
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (currentSt) {
                  ...
                  return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)($$new !== currentSt.width)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new WidthChanged($$new)))(function () {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $18 = {};
                          for (var $19 in currentSt) {
                              if ({}.hasOwnProperty.call(currentSt, $19)) {
                                  $18[$19] = currentSt[$19];
                              };
                          };
                          $18.width = $$new;
          ...
          if (v instanceof HandleHeightInput) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (currentSt) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)($$new !== currentSt.height)(Halogen_Query_HalogenM.raise(new HeightChanged($$new))))(function () {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $30 = {};
                          for (var $31 in currentSt) {
                              if ({}.hasOwnProperty.call(currentSt, $31)) {
                                  $30[$31] = currentSt[$31];
                              };
                          };
                          $30.height = $$new;
          ...
          if (v instanceof ForwardRunButtonClicked) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      $42.isRunning = !st.isRunning;
                      return $42;
                  })()))(function () {
                      return Halogen_Query_HalogenM.raise(RunButtonClicked.value);
                  });
              });
          };
...
(function($PS) {
  ...
  var take = function (n) {
      ...
      var $22 = go(n);
      return function ($23) {
          return $22(Data_Stream_Types.step($23));
      };
  };
  var tail = function ($24) {
      return (function (v) {
          return v.tail;
      })(uncons($24));
  };
...
(function($PS) {
  ...
  var toArray = function (n) {
      var $19 = Data_Array.fromFoldable(Data_List_Lazy_Types.foldableList);
      var $20 = Data_Stream.take(n);
      return function ($21) {
          return $19($20(right(Data_Zipper_Types.shiftl($21))));
      };
  };
...
(function($PS) {
  ...
  var right = (function () {
      var $13 = Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Zipper_Types.shiftr);
      var $14 = Data_Newtype.unwrap(newtypeGrid);
      return function ($15) {
          return Grid($13($14($15)));
      };
  })();
  var up = (function () {
      var $16 = Data_Newtype.unwrap(newtypeGrid);
      return function ($17) {
          return Grid(Data_Zipper_Types.shiftl($16($17)));
      };
  })();
  var left = (function () {
      var $18 = Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Zipper_Types.shiftl);
  ...
  var functorGrid = new Data_Functor.Functor(function (f) {
      var $21 = Data_Functor.map(Data_Zipper_Types.functorStream)(Data_Functor.map(Data_Zipper_Types.functorStream)(f));
      var $22 = Data_Newtype.unwrap(newtypeGrid);
      return function ($23) {
          return Grid($21($22($23)));
      };
  });
  var fromArray2 = function (a) {
      return function (xss) {
          var universe = Data_Stream.fromFoldable(Data_Foldable.foldableArray)(Data_Zipper.symmetric(a))(Data_Functor.map(Data_Functor.functorArray)((function () {
              var $24 = Data_Zipper.fromStream(a);
              var $25 = Data_Stream.fromFoldable(Data_Foldable.foldableArray)(a);
              return function ($26) {
                  return $24($25($26));
              };
          })())(xss));
  ...
  var focus = (function () {
      var $27 = Control_Comonad.extract(Data_Zipper_Types.comonadZipper);
      var $28 = Control_Comonad.extract(Data_Zipper_Types.comonadZipper);
      var $29 = Data_Newtype.unwrap(newtypeGrid);
      return function ($30) {
          return $27($28($29($30)));
      };
  })();
  var extendGrid = new Control_Extend.Extend(function () {
      ...
      var $31 = Data_Functor.map(functorGrid)(f);
      return function ($32) {
          return $31(dupl($32));
      };
  });
  var down = (function () {
      var $33 = Data_Newtype.unwrap(newtypeGrid);
      return function ($34) {
          return Grid(Data_Zipper_Types.shiftr($33($34)));
      };
  })();
  exports["up"] = up;
  exports["down"] = down;
...
(function($PS) {
  ...
  var component = function (dictMonadEffect) {
      ...
      var handleEditPanelMessage = function (v) {
          ...
          throw new Error("Failed pattern match at Conway.Page.Conway (line 109, column 30 - line 114, column 48): " + [ v.constructor.name ]);
      };
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Conway.Page.Conway (line 86, column 20 - line 106, column 42): " + [ v.constructor.name ]);
      };
      ...
      var render = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap3.containerFluid) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap3.row) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap3.colMd10, Halogen_Themes_Bootstrap3.colMdOffset2, Halogen_Themes_Bootstrap3.textCenter ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-content") ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_("conway-title") ])([ Halogen_HTML_Core.text("\ud83c\udf35\u3089\u3044\u3075\u3052\u301c\u3080\ud83c\udf35") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-content-body") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("conway-config-panel-area"), panelStyle ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "editPanel";
          }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Conway_Component_EditPanel.component(dictMonadEffect))({
              width: v.width,
              height: v.height,
              step: v.step,
              ...
              return "board";
          }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Conway_Component_Board.component(dictMonadEffect))({
...
(function($PS) {
  ...
  var app = function (dictMonadEffect) {
      var render = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("app") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "view";
          }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Conway_Page_Conway.component(dictMonadEffect))(Data_Unit.unit)(Data_Void.absurd) ]);
      };
      return Halogen_Component.mkComponent({
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      ...
      var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(Conway_AppM.runAppM(env))(app(Conway_AppM.monadEffectAppM));
